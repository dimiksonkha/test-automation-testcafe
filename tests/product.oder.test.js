...
import Page from "../page-objects/pages/Page";
...
test.page `https://opencart.abstracta.us/index.php?route=account/login`
 ('should be able to order a  product as registered customer', async t=>{
